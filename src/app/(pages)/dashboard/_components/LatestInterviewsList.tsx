        ...
        <>
          ...
          {interviewList?.length == 0 ? (
           <Card className="gap-2 p-5 flex flex-col justify-center items-center h-[300px] border-dashed">
            <Camera className="h-10 w-10 p-2 text-blue-600 bg-blue-100 rounded-full" />
             ...
             <Button 
              className="cursor-pointer mt-3 bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2"
