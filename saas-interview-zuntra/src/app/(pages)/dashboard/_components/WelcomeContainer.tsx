...
const WelcomeContainer = async () => {
  ...
  return (
    <div className="flex items-center justify-between bg-gradient-to-r from-blue-50 to-slate-100 p-6 rounded-xl shadow-md border border-slate-200 transition-all duration-300">
      {/* Left Section - Welcome Text */}
      <div className="ml-0 lg:ml-10 transition-all duration-300">
